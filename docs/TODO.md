...
Here you will find the official TODO (ROADMAP) list for Zulfiqar OS Linux. The
list contains items (tasks or projects) with a status for the current and
upcoming year. It also gives an overview of which Zulfiqar OS team member works on
what.
...
**Web:** https://www.zulfiqar.org/

**Mail:** team@zulfiqar.org

**IRC:** [irc://irc.freenode.net/zulfiqar](irc://irc.freenode.net/zulfiqar)
...
===> 2021
  ...
  [ ] all git/svn/hg packages
      ...
      [noptrix,?] 
  [.] youtube
      create / add initial videos: zulfiqar-installation (2 parts: online and
      from live-iso)
      [noptrix,?]
  ...
  [ ] wiki
      replace the zulfiqar guide with a fresh new wiki. it is planned to use
      github for .md files and reference them on the zulfiqar website rather
      than having a complete wiki setup on zulfiqar site. this still needs to
      be discussed!
      [all]

  [ ] howto-dev
      update the howto for zulfiqar developers
      [noptrix]
...
===> 2019
  ...
  [x] zulfiqar-config-*
      update, tweak, improve and QA all zulfiqar-config-* packages.
      [noptrix]
...
===> 2018
  ...
  [x] howto-dev
      create an initial quick'n'dirty how-to for zulfiqar developers
      [noptrix]
